...
async function run() {
  ...
  approx(worldRes.medFids.rel_qOn, -30, 1, "world rel_qOn");
  approx(worldRes.medFids.rel_qOff, 34, 1, "world rel_qOff");
  approx(worldRes.medFids.rel_tEnd, 364, 2, "world rel_tEnd");
  approx(worldRes.measures.QRS, 64, 2, "world QRS");
  approx(worldRes.measures.QT, 394, 2, "world QT");
  approx(worldRes.measures.QTcB, 508.4, 3, "world QTcB");
  approx(worldRes.measures.QTcF, 467.0, 3, "world QTcF");
  approx(worldRes.measures.QTcFram, 455.5, 2, "world QTcFram");
  approx(worldRes.measures.axes.qAxis, 69.3, 1, "world QRS axis");
  ...
  approx(basicRes.medFids.rel_qOn, -71, 2, "basic rel_qOn");
  approx(basicRes.medFids.rel_qOff, 32, 2, "basic rel_qOff");
  approx(basicRes.medFids.rel_tEnd, 327, 2, "basic rel_tEnd");
  approx(basicRes.measures.QRS, 103, 3, "basic QRS");
  approx(basicRes.measures.QT, 398, 3, "basic QT");
  approx(basicRes.measures.QTcB, 513.8, 3, "basic QTcB");
  approx(basicRes.measures.QTcF, 471.9, 3, "basic QTcF");
  approx(basicRes.measures.QTcFram, 459.6, 3, "basic QTcFram");
